# Synthetic Project Handover

This exercise contains fictional values only. Never paste credentials, private
paths, unpublished data, or real participant information here.
